module DiffusionCLs
    ...
    !case default
    !   print *, 'Please enter a valid integration scheme (1: Euler-Maruyama, 2: Explicit Midpoint, 3: Implicit Trapezoidal) in the diffCLs.nml file'
